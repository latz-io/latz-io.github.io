...
In this work, we essentially use the Multilevel Sequential² Monte Carlo framework for the estimation of rare events rather than
...
Finally, we consider MCMC algorithms that are based on adaptive von Mises-Fischer-Nakagami proposals. 
